...
df = pd.read_csv(r'C:\Users\cando\OneDrive\Desktop\Workspaces\Sales Analysis\retailsales.csv')
...
# Plot for 'Average sales across different age groups and product categories'
...
# Plot for 'Monthly average sales of different product'
...
# Plot for 'Seasonal average sales across different product categories'
...
## 4(b) Distribution of different price per unit across different categories
